...
@section('title', __('User Identity Reverification'))
@section('style')
                ...
                <div class="customMarkup__single">
                    <div class="customMarkup__single__item">
                        <div class="customMarkup__single__item__flex">
                            <h4 class="customMarkup__single__title">{{ __('User Identity Reverification') }}</h4>
                        </div>
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="{{route('admin.user.identity.reverification')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <x-form.text
                                    :title="__('Email Subject')"
                                    :type="__('text')"
                                    :name="'user_identity_re_verify_subject'"
                                    :id="'user_identity_re_verify_subject'"
                                    :value="get_static_option('user_identity_re_verify_subject') ?? __('User Identity Reverification')"
                                />
                                <x-form.summernote
                                    :title="__('Email Message')"
                                    :name="'user_identity_re_verify_message'"
                                    :id="'user_identity_re_verify_message'"
                                    :value="get_static_option('user_identity_re_verify_message') ?? ''"
                                />
