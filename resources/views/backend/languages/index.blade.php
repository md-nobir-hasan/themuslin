            ...
            <div class="col-lg-6">
                ...
                <div class="dashboard__card">
                    <div class="dashboard__card__header">
                        <h4 class="dashboard__card__title">{{ __('All Languages') }}</h4>
                    </div>
                    <div class="dashboard__card__body table-responsive mt-4">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul class="language__list">
                                                    <li><strong class="language__list__strong">{{ 'Name' }}</strong>
                                                        <span class="language__list__span">{{ $data->name }}</span>
                                                    </li>
                                                    <li><strong class="language__list__strong">{{ 'Direction' }}</strong>
                                                        <span
                                                            class="language__list__span">{{ strtoupper($data->direction) }}</span>
                                                    </li>
                                                    <li><strong class="language__list__strong">{{ 'Slug' }}</strong>
                                                        <span
                                                            class="language__list__span">{{ strtoupper($data->slug) }}</span>
                                                    </li>
                                                    <li><strong class="language__list__strong">{{ 'Status' }}</strong>
                                                        <span
                                                            class="language__list__span">{{ strtoupper($data->status) }}</span>
                                                    </li>
                                                </ul>
                                            </td>
                                            <td>
        ...
        (function($) {
            ...
            $(document).ready(function() {
                ...
                $(document).on('change', 'select[name="language_select"]', function() {
                    var el = $(this);
                    var name = el.parent().find('select[name="language_select"] option[value="' + el
                        .val() + '"]').text()
                ...
                $(document).on('click', '.lang_edit_btn', function() {
                    ...
                    form.find('select[name="language_select"] option[value="' + slug + '"]').attr(
                        'selected', true);
                    form.find('#edit_slug').val(slug);
                    form.find('#edit_direction option[value="' + el.data('direction') + '"]').prop(
                        'selected', true);
                    form.find('#edit_status option[value="' + el.data('status') + '"]').prop('selected',
                        true);
                });
