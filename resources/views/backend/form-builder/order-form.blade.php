            ...
            <div class="col-lg-6">
                ...
                <div class="dashboard__card">
                    <div class="dashboard__card__body">
                        <h4 class="dashboard__card__title">{{ __('Order Form Builder') }}</h4>
                        <div class="alert alert-danger alert-block ">
                            <strong><i class="ti-hand-point-right mr-1"></i>
                                {{ __("Note: Please, don't add Name & Email Form Fields here!") }}</strong>
                        </div>
