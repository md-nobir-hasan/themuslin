                                ...
                                <tbody>
                                    <tr>
                                        <td align="center" style="padding-top:25px" valign="middle">
                                            <a href="{{url('/')}}" tyle="display:block;text-decoration:none">
                                                <img src="https://project.bestinbd.com/2310MUS/assets/muslin/images/static/logo.png">
                                            </a>
                                        </td>
                                    </tr>
                                </tbody>
                                            ...
                                            <table align="center" border="0" cellpadding="0" cellspacing="0"
                                                ...
                                                <tr>
                                                    <td align="left"
                                                        ...
                                                        valign="middle">
                                                        {{ __("Product") }} {{ $order?->orderItem?->count() }} 
                                                    </td>
                                                </tr>
                                                <tr align="center">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" valign="middle">
                                                    <table align="right" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="right"
                                                                style="font-size:15px;font-style:normal;line-height:24px;font-weight:400;font-family:'Roboto','Arial',sans-serif"
                                                                valign="middle">
                                                                <strong>{{ $paymentMeta->total_amount }}</strong>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <table align="center" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td align="left"
                                                    style="color:#3f3f3f;font-size:15px;font-style:normal;line-height:24px;font-weight:400;font-family:'Roboto','Arial',sans-serif"
                                                    valign="middle">
                                                    Payment Method: {{ $mainOrder->payment_gateway == 'cash_on_delivery' ? 'Cash on Delivery' : 'Online Payment' }}
                                                </td>
                                                <td align="center" valign="middle">
                                                    <table align="right" border="0" cellpadding="0" cellspacing="0"
                                                           role="presentation" style="width:105px" width="105">
