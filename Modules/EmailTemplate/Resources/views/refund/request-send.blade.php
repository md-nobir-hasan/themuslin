                ...
                <div class="card-body">
                    <div class="customMarkup__single__item">
                        ...
                        <div class="customMarkup__single__inner mt-4">
                            <form action="{{ route('admin.email-template.refund.request-send') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')

                                <x-form.text
                                    :title="__('Email Subject')"
                                    :type="__('text')" :name="'refund_request_send_mail_subject'" :id="'refund_request_send_mail_subject'"
                                    :value="get_static_option('refund_request_send_mail_subject') ?? __('Refund request send')" />

                                <x-form.summernote
                                    :title="__('Email Message')" :name="'refund_request_send_mail_body'" :id="'refund_request_send_mail_body'"
