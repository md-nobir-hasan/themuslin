...
<div class="modal-wrapper" id="media_upload_modal" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{ __('Media Uploads') }}</h5>
                <button type="button" class="close-icon media_upload_modal_submit_btn close-select-button"
            ...
            <div class="modal-body">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="upload_media_image" data-bs-toggle="tab" href="#upload_files"
                            role="tab" aria-selected="true">{{ __('Upload Files') }}</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#media_library" role="tab"
                ...
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="upload_files" role="tabpanel">
                        <div class="dropzone-form-wrapper">
                            <form action="{{ route($type . '.upload.media.file') }}" method="post"
                                        ...
                                        <ul class="img-meta" style="display: none">
                                            ...
                                            <li class="imgalt">
                                                <div class="img-alt-wrap">
                                                    ...
                                                    <button class="btn btn-success img_alt_submit_btn"  style="margin-top:20px;"><i
                                                            class="las la-check"></i></button>
                                                </div>
                                            </li>
                                        </ul>
                                        <a tabindex="0" style="display: none"
                                            class=" btn btn-lg btn-danger btn-sm mb-2 me-1 media_library_image_delete_btn"
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary media_upload_modal_submit_btn close-select-button"
