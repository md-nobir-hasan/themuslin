...
<script>
    (function ($) {
        ...
        $(document).on('click', '.media_upload_modal_submit_btn', function (e) {
            ...
            if (typeof allData != 'undefined') {
                ...
                $.each(allData, function (index, value) {
                    ...
                    mainUploadBtn.parent().find('.img-wrap').append('<div class="rmv-span"><i class="@if($type === 'admin') fas fa-trash @else las la-trash @endif"></i></div><div class="attachment-preview"><div class="thumbnail"><div class="centered"><img src="' + el.imgsrc + '"></div></div></div>');
                });
        ...
        $('body').on('click', '.media-uploader-image-list > li', function (e) {
            ...
            $('.img_alt_submit_btn').html('<i class="@if($type === 'admin') las la-check @else las la-check @endif"></i>');
        ...
        $(document).on('click', '.img_alt_submit_btn', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    $('.img_alt_submit_btn').html('<i class="@if($type === 'admin') las la-check-circle @else  las la-check-circle  @endif"></i>');
        ...
        $(document).on('click', '#loadmorewrap', function () {
            ...
            $('#loadmorewrap button').append(' <i class="@if($type === 'admin') fas fa-spinner fa-spin @else las la-spinner la-spin @endif "></i>');
            $.ajax({
                type: "POST",
