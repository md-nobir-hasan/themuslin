            ...
            <div class="col-lg-12">
                ...
                <div class="dashboard__card">
                    ...
                    <div class="dashboard__card__body mt-4">
                        <div id="page-builder-wrap" class="page-builder-content-wrap">
                            <div class="row">
                                <div class="col-lg-6">
    ...
    <script>
        (function($) {
            ...
            $(document).ready(function() {
                ...
                /*----------------------------------
                 *   SHOW WIDGET IMAGE ON HOVER
                 * ---------------------------------*/
                $(document).on('mouseover', '.all-addons-wrapper ul.ui-sortable li.widget-handler', function(
                    e) {
                ...
                $('body').on('click', '.expand', function(e) {
                    ...
                    if (expand.hasClass('ti-angle-down')) {
                        ...
                        summerNote.summernote({
                            ...
                            callbacks: {
                                onPaste: function(e) {
                                    var bufferText = ((e.originalEvent || e)
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (widgetType === 'new') {
                                ...
                                formContainer.find('input[name="addon_type"]').val(
                                    'update');
