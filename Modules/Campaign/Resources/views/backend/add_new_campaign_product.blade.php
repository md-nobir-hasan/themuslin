<div class="dashboard__card">
    ...
    <div class="dashboard__card__body custom__form mt-4">
        ...
        <div class="form-group">
            <label for="campaign_price">{{ __('Price for Campaign') }}<span class="text-danger">*</span></label>
        ...
        <div class="form-group">
            <label for="units_for_sale">{{ __('No. of Units for Sale') }}<span class="text-danger">*</span></label>
